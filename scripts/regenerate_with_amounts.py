"""
Regenerate sample messages using the improved XML generator with proper amount handling.
"""
import os
import sys
import json
...
from iso_message_generator.improved_xml_generator import create_sample_xml
...
def main():
    ...
    scenarios = [
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '5000.00',
        ...
        },
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '7500.00',
        ...
        },
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '25000.00',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt/Ccy': 'CAD',
        ...
        },
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '15000.00',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt/Ccy': 'CAD',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/InstdAmt': '15000.00',
        ...
        },
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '3500.00',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt/Ccy': 'CAD',
        ...
        },
        {
            ...
            'key_fields': {
                ...
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt': '10000.00',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/IntrBkSttlmAmt/Ccy': 'EUR',
                '/Document/FIToFICstmrCdtTrf/CdtTrfTxInf/InstdAmt': '12000.00',
    ...
    print(f"Defined {len(scenarios)} payment scenarios with proper amount values")
